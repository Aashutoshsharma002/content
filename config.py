...
# Flask Configuration
SESSION_SECRET = os.environ.get("SESSION_SECRET", "dev_session_secret_not_for_production")
if not os.environ.get("SESSION_SECRET"):
    logger.warning("SESSION_SECRET not found in environment variables. Using insecure default for development only.")
